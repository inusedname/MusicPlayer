...
public final class DemoUtil {
  ...
  private static @MonotonicNonNull DownloadCenter downloadCenter;
...
//      }
  ...
  public static synchronized DownloadCenter getDownloadCenter(Context context) {
    ensureDownloadManagerInitialized(context);
  ...
  private static synchronized void ensureDownloadManagerInitialized(Context context) {
    if (downloadManager == null) {
      ...
      downloadCenter =
          new DownloadCenter(context, getHttpDataSourceFactory(context), downloadManager);
    }
  }
